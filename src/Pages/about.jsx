  ...
  return (
    <div className="bg-[#386389] min-h-screen h-fit flex justify-center relative overflow-hidden ">
      <div className="max-w-[1920px] flex justify-center">
        ...
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-15 h-15 top-[20%] left-[15%] rotate-45 opacity-20" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-13 h-13 top-[30%] right-[20%] -rotate-12 opacity-30" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-17 h-17 bottom-[30%] left-[25%] rotate-90 opacity-50" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-14 h-14 top-[50%] right-[15%] rotate-180 opacity-40" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-12 h-12 bottom-[20%] right-[30%] rotate-[135deg] opacity-30" />
