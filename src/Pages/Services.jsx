  ...
  return (
    <div className="bg-[#386389] min-h-screen h-fit flex relative justify-center ">
      ...
      <div className="max-w-[1920px] w-full">
       <img src="/src/assets/sparkle.svg" alt="" className="absolute w-15 h-15 top-[60%] left-[15%] rotate-70 opacity-40" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-13 h-13 top-[10%] right-[60%] -rotate-30 opacity-50" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-17 h-17 bottom-[30%] left-[25%] rotate-90 opacity-70" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-14 h-14 top-[30%] right-[15%] rotate-180 opacity-80" />
        <img src="/src/assets/sparkle.svg" alt="" className="absolute w-12 h-12 bottom-[40%] right-[30%] rotate-[135deg] opacity-50" />
