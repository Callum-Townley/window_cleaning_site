...
function Home() {
  return (
    <div id="home" className="relative bg-[url('/assets/conservatory_cleaning.jpg')] bg-cover bg-center min-h-screen h-fit flex  justify-center pb-40 ">
      ...
      <div className=" bg-opacity-80 p-10 rounded-lg text-center max-w-[1920px] sm:max-w-[60%] mt-[15%] mx-4 z-10">
        <h1 className="text-[clamp(1.5rem,3.5vw,4rem)] font-poppins font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white from-70% to-gray-400">PROFESSIONAL WINDOW CLEANING IN YOUR LOCAL AREA</h1>
